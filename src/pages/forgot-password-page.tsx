  ...
  return (
    <Container>
      <Flex justify={'center'} align={'center'} direction={'column'} gap={'lg'} mt={'xl'}>
        ...
        <Text>
          Enter the email address linked to your account so that we can send you an recovery link
        </Text>
        <TextInput
          label={'email address'}
          size="lg"
        ...
        {showText && <Text fw={700}>You will recieve a recovery email in your inbox soon</Text>}
      </Flex>
    </Container>
  );
};
